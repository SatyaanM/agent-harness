...
- File tools perform lexical containment and resolve existing paths or the nearest existing write ancestor before authorization. Directory traversal through an existing symlink is rejected; globbing and grep traversal do not follow symbolic links.
